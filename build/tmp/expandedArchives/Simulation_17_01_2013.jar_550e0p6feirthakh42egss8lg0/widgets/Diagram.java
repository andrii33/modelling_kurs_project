...
public class Diagram extends javax.swing.JPanel {
	...
	class IvjEventHandler implements java.awt.event.ActionListener,
		...
		// обработчик событи€ по клику в контекстном меню "очистить"
		...
		/*
		 * (non-Javadoc)
		 *  ќтображение контекстного меню по клику мышки
		 */
...
try {
	...
	public synchronized void drawBarsDiagram(double borders[], // массив границ
			...
			double width, // ширина столбика в дол€х ширины интервала
			double shift, // смещение столбика от левой границы промежутка
			boolean reSet) // требуетс€ ли изменение настройки диаграммы
	...
	/**
	 * ¬ывод графической зависимости между последовательност€ми Creation date:
	 * (05.11.2005 23:18:02)
	 * 
	 * @param anInt
	 *            int
	...
	// массив значений по горизонтали (возрастающий)
			double[] frequency, // массив значений по вертикали (в промежутках)
			double width, // ширина иглы в в дол€х ширины интервала
			boolean reSet) // требуетс€ ли изменение настройки диаграммы
	...
	private javax.swing.JMenuItem getJMenuItem1() {
		if (ivjJMenuItem1 == null) {
			try {
				...
				ivjJMenuItem1.setText("ќчистить");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getTitle() {
		if (ivjTitle == null) {
			try {
				...
				ivjTitle.setText("«аголовок диаграммы");
				ivjTitle
...
//	}
	...
	/**
	 *  создаем пункт контекстного меню дл€ диаграммы, использу€ паттерн синглтон
	 */
